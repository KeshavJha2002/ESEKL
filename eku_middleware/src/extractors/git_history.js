/**
 * Git History & Bug Fix Archaeologist (ESM)
 */

import { execSync } from "node:child_process";

export function extractBugFixHistory(repoPath, limit = 250) {
  try {
    ...
    console.error("Warning: Git history extraction failed:", err.message);
    return [];
  }
}
